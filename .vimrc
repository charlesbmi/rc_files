...
"" set list " causes d $ at end of line
...
nmap <F7> :tabp<CR>                 " mapping f7 to prev tab
nmap <F8> :tabn<CR>                 " mapping f8 to next tab
...
au FileType arduino set formatoptions=croql
